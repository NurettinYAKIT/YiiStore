...
class Album extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('GenreId, ArtistId, Title, Price, tracks', 'required'),
			...
			array('LinerNotes', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('AlbumId, GenreId, ArtistId, Title, Price, AlbumThumbUrl, AlbumArtUrl, tracks, LinerNotes', 'safe', 'on'=>'search'),
		);
	}
