...
/**
 * This is the model class for table "tbl_room_reservation".
 *
 * The followings are the available columns in table 'tbl_room_reservation':
 * @property integer $id
...
class RoomReservation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('room_id, reservation_id', 'length', 'max'=>45),
			array('entrance_date, exit_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, room_id, reservation_id, entrance_date, exit_date', 'safe', 'on'=>'search'),
		);
	}
